...
class ToDoProjectTasks extends Component {
    componentDidMount() {
    ...
    render() {
        return (
            <div>
                {this.props.projectTasks.project_tasks.map(pt => (pt.status === "TO_DO" ?
...
export default connect(mapStateToProps, mapDispatchToProps)(ToDoProjectTasks);