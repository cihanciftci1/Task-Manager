...
class DoneProjectTasks extends Component {
    componentDidMount() {
    ...
    render() {
        return (
            <div>
                {this.props.projectTasks.project_tasks.map(pt => (pt.status === "DONE" ?
...
export default connect(mapStateToProps, mapDispatchToProps)(DoneProjectTasks);